(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('rxjs/internal/operators'), require('@angular/core'), require('@angular/router'), require('@angular/common'), require('@angular/platform-browser/animations'), require('@angular/material/toolbar'), require('@angular/material/list')) :
    typeof define === 'function' && define.amd ? define('ng7-mat-breadcrumb', ['exports', 'rxjs/operators', 'rxjs/internal/operators', '@angular/core', '@angular/router', '@angular/common', '@angular/platform-browser/animations', '@angular/material/toolbar', '@angular/material/list'], factory) :
    (factory((global['ng7-mat-breadcrumb'] = {}),global.rxjs.operators,global.rxjs['internal/operators'],global.ng.core,global.ng.router,global.ng.common,global.ng.platformBrowser.animations,global.ng.material.toolbar,global.ng.material.list));
}(this, (function (exports,operators,operators$1,i0,router,common,animations,toolbar,list) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Ng7MatBreadcrumbComponent = /** @class */ (function () {
        function Ng7MatBreadcrumbComponent(activatedRoute, router$$1) {
